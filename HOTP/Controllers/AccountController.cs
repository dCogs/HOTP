...
namespace HOTP.Controllers
{
    ...
    public class AccountController : Controller
    {
                ...
                case SignInStatus.Success:
                    {
                        ...
                        //if (tblHOTP_Employees.Admin) user.AdminUser = "Yes";
                        //else user.AdminUser = "No";
        ...
        public void SetCookie(tblHOTP_Employees tblHOTP_Employees)
        {
            string CookieName = "HOTPgoals";
            HttpCookie myCookie = HttpContext.Request.Cookies[CookieName] ?? new HttpCookie(CookieName);
            myCookie.Values["EmployeeID"] = tblHOTP_Employees.EmployeeID.ToString();
            myCookie.Values["FirstName"] = tblHOTP_Employees.FirstName;
            myCookie.Values["LastName"] = tblHOTP_Employees.LastName;
            myCookie.Values["SupervisorID"] = tblHOTP_Employees.SupervisorID.ToString();
            myCookie.Values["Admin"] = tblHOTP_Employees.Admin.ToString();
            myCookie.Values["Evaluations"] = tblHOTP_Employees.Evaluations.ToString();
        ...
        //{
        //    HttpCookie myCookie = HttpContext.Request.Cookies["HOTPgoals"];
        //    if (myCookie != null)
        //    {
        //    }
        //}
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // try something else; the following line doesn't send
